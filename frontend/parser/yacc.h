...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOKEN_AND = 277,               // AND
    TOKEN_OR = 278,                // OR
    TOKEN_BITAND = 279,            // BITAND
    TOKEN_BITOR = 280,             // BITOR
    TOKEN_NOT = 281,               // NOT
    TOKEN_INT = 282,               // INT
    TOKEN_FLOAT = 283,             // FLOAT
    TOKEN_STRING = 284,            // STRING
    TOKEN_VOID = 285,              // VOID
    TOKEN_IDENT = 286,             // IDENT
    TOKEN_IF = 287,                // IF
    TOKEN_ELSE = 288,              // ELSE
    TOKEN_FOR = 289,               // FOR
    TOKEN_WHILE = 290,             // WHILE
    TOKEN_CONTINUE = 291,          // CONTINUE
    TOKEN_BREAK = 292,             // BREAK
    TOKEN_SWITCH = 293,            // SWITCH
    TOKEN_CASE = 294,              // CASE
    TOKEN_GOTO = 295,              // GOTO
    TOKEN_DO = 296,                // DO
    TOKEN_RETURN = 297,            // RETURN
    TOKEN_CONST = 298,             // CONST
    TOKEN_SEMICOLON = 299,         // SEMICOLON
    TOKEN_COMMA = 300,             // COMMA
    TOKEN_LPAREN = 301,            // LPAREN
    TOKEN_RPAREN = 302,            // RPAREN
    TOKEN_LBRACKET = 303,          // LBRACKET
    TOKEN_RBRACKET = 304,          // RBRACKET
    TOKEN_LBRACE = 305,            // LBRACE
    TOKEN_RBRACE = 306,            // RBRACE
    TOKEN_END = 307,               // END
    TOKEN_THEN = 308               // THEN
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_STMT = 57,                             // STMT
        S_CONTINUE_STMT = 58,                    // CONTINUE_STMT
        S_EXPR_STMT = 59,                        // EXPR_STMT
        S_VAR_DECLARATION = 60,                  // VAR_DECLARATION
        S_VAR_DECL_STMT = 61,                    // VAR_DECL_STMT
        S_FUNC_BODY = 62,                        // FUNC_BODY
        S_FUNC_DECL_STMT = 63,                   // FUNC_DECL_STMT
        S_FOR_STMT = 64,                         // FOR_STMT
        S_IF_STMT = 65,                          // IF_STMT
        S_RETURN_STMT = 66,                      // RETURN_STMT
        S_WHILE_STMT = 67,                       // WHILE_STMT
        S_BLOCK_STMT = 68,                       // BLOCK_STMT
        S_PARAM_DECLARATOR = 69,                 // PARAM_DECLARATOR
        S_PARAM_DECLARATOR_LIST = 70,            // PARAM_DECLARATOR_LIST
        S_VAR_DECLARATOR = 71,                   // VAR_DECLARATOR
        S_VAR_DECLARATOR_LIST = 72,              // VAR_DECLARATOR_LIST
